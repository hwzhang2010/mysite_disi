...
const instance = axios.create({
  timeout: 120000, // 设置超时时间120s
  //baseURL: 'http://154.8.158.23:8901'
  //baseURL: 'http://172.18.10.63:8901'
  baseURL: 'http://localhost:8901'
  //baseURL: process.env.NODE_ENV === 'prod' ? '' : 'http://localhost:8901' //根据自己配置的反向代理去设置不同环境的baseUrl
});
